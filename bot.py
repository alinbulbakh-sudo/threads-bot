...
COMMENT_SCRIPTS = {
    ...
    "ads": [
        "Привіт! Займаюсь Meta Ads для бізнесу з послуг — якщо хочеш розібратись що не так, можу подивитись без зобов'язань 🙌",
        "Яка ніша? Є кейси по юристах та майстрах — можу підказати що зазвичай працює в Meta 🔥",
        "Знайоме 😅 Зазвичай проблема або в аудиторії або в крео. Пиши в дірект — розберемось",
        "Таргетолог тут 👋 Спеціалізуюсь на послугах. Якщо хочеш — можу зробити міні-аудит кабінету, безкоштовно",
        "Це вирішується — питання в налаштуваннях кампанії. Пиши якщо хочеш розібратись 🙌",
    ],

    # Коли тату-майстри постять роботи або шукають клієнтів
    "tattoo": [
        "Роботи 🔥 Якщо захочеш більше клієнтів через рекламу — займаюсь просуванням майстрів, є кейси. Пиши!",
        "Скільки зараз клієнтів на місяць? Питаю бо займаюсь таргетом для тату-майстрів — знаю як масштабуватись 😊",
        "Красиво! До речі, якщо цікавить реклама — є досвід з тату-студіями, добре знаю цю нішу 🙌",
    ],

    # Коли шукають адвоката (пишемо якщо SAМ адвокат може читати)
    "legal": [
        "Якщо ти адвокат і хочеш більше клієнтів через рекламу — займаюсь просуванням юристів, є кейс. Напиши 😊",
        "До речі, якщо ви самі юрист — знаю як залучати клієнтів через Meta Ads в цій ніші. Пишіть!",
    ],

    # Треди самореклами / "хто чим займається"
    "selfpromo": [
        "Аліна, таргетолог 👋 Запускаю рекламу для бізнесу з послуг — адвокати, майстри, локальний бізнес. Є кейс де юрист отримав 40+ звернень за місяць з Meta Ads. Пиши якщо цікаво!",
        "Таргетолог тут! Спеціалізуюсь на послугах — є кейси по тату-майстрах та юристах. Пиши якщо потрібна реклама 🔥",
    ...
    # Загальний (fallback)
    "general": [
        "Займаюсь таргетом для послуг — якщо цікаво поговорити про рекламу, пиши 🙌",
